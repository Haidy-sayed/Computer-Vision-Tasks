...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.filterInSDomianLabel = QtWidgets.QLabel(self.filtersWigdet)
        self.filterInSDomianLabel.setEnabled(True)
        self.filterInSDomianLabel.setText("")
        self.filterInSDomianLabel.setObjectName("filterInSDomianLabel")
        self.horizontalLayout_3.addWidget(self.filterInSDomianLabel)
        self.line_2 = QtWidgets.QFrame(self.filtersWigdet)
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.horizontalLayout_3.addWidget(self.line_2)
        self.filterInFDomainLabel = QtWidgets.QLabel(self.filtersWigdet)
        self.filterInFDomainLabel.setText("")
        self.filterInFDomainLabel.setObjectName("filterInFDomainLabel")
        self.horizontalLayout_3.addWidget(self.filterInFDomainLabel)
